...
(keymap-global-set "C-M-1" 'delete-other-windows)
(keymap-global-set "C-M-2" 'split-window-below)
(keymap-global-set "C-M-3" 'split-window-right)
(keymap-global-set "C-M-0" 'delete-window)
